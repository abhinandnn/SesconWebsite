...
const Available = () => {
  return (
    <div className=" w-11/12 mx-auto px-[4vw] flex gap-[64px] flex-col mb-[104px]">
      ...
      <div className=" grid grid-cols-2 gap-[93px] md1:grid-cols-1">
        ...
        <div className=" text-[32px] text-black leading-[44.4px] font-[400] flex flex-col gap-16 pb-[40px]">
          <div>
