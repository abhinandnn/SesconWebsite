      ...
      <FadeInSection>
        <div className="flex md1:flex-col md1:gap-[2rem] gap-[4rem] justify-between pb-[4rem]">
          ...
          <div className="text-[1.5rem]  sm:text-[1.375rem] mob:text-[1.25rem]">
            ...
            <br />
            <br />
            <Link href={"tel:+91842932309"} className="text-[#B33F0F]">
              +91842932309
            </Link>{" "}
            or{" "}
            <Link
              href={"mailto:sescon.contact@gmail.com"}
              className="text-[#B33F0F]"
            >
        ...
        <div className="">
          ...
          <div className="pt-4 flex justify-between flex-wrap gap-[2rem]">
            ...
            <form className="font-Lexend text-black max-w-xl w-[40rem]">
              ...
              <button
                type="submit"
                className="text-white bg-[#B33F0F] focus:ring-4 focus:outline-none font-medium rounded-lg text-sm w-[7rem] sm:w-auto px-5 py-2.5 text-center"
              >
                Submit
              </button>
            </form>
