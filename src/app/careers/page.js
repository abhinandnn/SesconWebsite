...
step towards a rewarding and fulfilling career with us.
    ...
    <CareerCard role={"Manager"} domain={"Marketing"} text={"Join Our Team! SESCON is seeking a dynamic and experienced Manager to lead our projects to success. Apply today!"}/>
    <CareerCard role={"Social Media Manager"} domain={"Marketing"} text={"Join Our Team! SESCON is seeking a dynamic and experienced Manager to lead our projects to success. Apply today!"}/>
    <CareerCard role={"Product Lead"} domain={"Marketing"} text={"Join Our Team! SESCON is seeking a dynamic and experienced Manager to lead our projects to success. Apply today!"}/>
...
<div className="pt-4 flex justify-between flex-wrap gap-[2rem]">
  ...
  <div className="relative z-0 w-full mb-5 group">
      ...
      <label for="position" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-[#B33F0F] peer-focus:dark:text-[#B33F0F] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Position Interest *</label>
  </div>
  <div className="relative z-0 w-full mb-5 group">
  ...
  <div>
  <label className="block mb-2 text-sm font-medium text-gray-400" for="user_avatar">Upload Resume *</label>
  ...
  <div className="text-[0.8rem] font-light">Accepted file types: pdf, docx, jpg, png
    <br/>
     Max file size: 5 MB</div>
  </div>
  <button type="submit" className="text-white w-[7.5rem] bg-[#B33F0F] focus:ring-4 focus:outline-none font-medium rounded text-sm  px-5 py-2.5 text-center">Submit</button>
</form>
</div>
</div>
    </div>
