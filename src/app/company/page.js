    ...
    <div className=" mt-[72px] overflow-x-hidden w-11/12 mx-auto grid grid-cols-[279px,auto] lg:grid-cols-[209px,auto] md1:grid-cols-1 gap-4">
      <div className=" md1:hidden lg:w-[209px] flex flex-col gap-14 leading-8 text-[22px] text-[#888888] font-medium justify-start cursor-pointer fixed ">
        <a
          ...
          className={`${activeSection == "management" ? "text-red-900" : null}`}
        >
          MANAGEMENT TEAM
        </a>
        <a
          ...
          className={`${activeSection == "organogram" ? "text-red-900" : null}`}
        >
          COMPANY ORGANOGRAM
        </a>
        <a
          ...
          className={`${activeSection == "technical" ? "text-red-900" : null}`}
        >
          TECHNICAL TEAM
        </a>
      </div>
          ...
          {managementTeam.map((item, index) => (
            ...
            >
              <div className="flex-shrink-0 sm:w-[50%]">
                <img src={item.img} className="sm:w-[100%]" alt={item.name} />
              </div>
              <div className="flex flex-col gap-8 sm:mt-[-80px] ">
                ...
                <div className="text-left  line-clamp-11 sm:mt-3 sm:line-clamp-3 ">{item.description}</div>
              </div>
            </div>
          ))}
        </div>
